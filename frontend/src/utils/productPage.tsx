...
const product = {
  ...
  product_image_4: "/images/products/j4.jpg",
  product_image_5: "/images/products/k1.jpg",
...
export default function ProductPage() {
  ...
  // Update active index when main image changes
  useEffect(() => {
  ...
  return (
    <div className="main-container max-w-6xl mx-auto p-4 pb-20 lg:pb-4">
      ...
      {/* Main content area - C3 and C4 with equal top spacing */}
        ...
        <div className="image-container lg:w-1/2 flex flex-col space-y-4">
          ...
          <div className="hidden lg:flex flex-row gap-4">
            ...
            <div className="thumbnail-container flex flex-col gap-2 justify-center">
              {images.map((img, idx) => (
                <img
                  ...
                  src={img}
                  alt={`Thumb ${idx}`}
                  className={`w-16 h-16 object-contain cursor-pointer border-1 rounded ${
                    mainImage === img
                      ? "border-red-500"
            ...
            <div className="flex-1 flex flex-col">
              <div
                className="image-box bg-white border rounded-lg overflow-hidden flex items-center justify-center p-1 cursor-pointer"
                style={{ height: "400px" }}
      ...
      {/* Fullscreen Image Modal with Swiper */}
      {isModalOpen && (
        <div className="fixed inset-0 bg-white z-50 flex flex-col">
          ...
          {/* Thumbnail Swiper with red border for active slide */}
                ...
                <SwiperSlide key={idx} style={{ width: "80px" }}>
                  <div className="h-full flex items-center justify-center p-1">
                    <img
                      src={img}
                      alt={`Thumb ${idx}`}
                      className={`h-full w-full object-contain cursor-pointer rounded border-2 ${
                        activeIndex === idx
                          ? "border-red-500"
                          : "border-gray-200"
                      }`}
                      onClick={() => {
                        if (modalSwiperRef.current) {
                          modalSwiperRef.current.swiper.slideTo(idx);
                        }
                      }}
                    />
                  </div>
